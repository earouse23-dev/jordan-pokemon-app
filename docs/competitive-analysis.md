...
> Historical note: this 2026-07-20 rotation is retained for provenance. The
> current software-only workflow benchmark and evidence ledger are
> [Mica Step 2](MICA_STEP2_COMPETITOR_BENCHMARK.md). Where they conflict, the Step
> 2 benchmark controls roadmap engineering requirements.
