const SHELL_CACHE = 'mica-shell-v77';
const RUNTIME_CACHE = 'mica-runtime-v1';
const RUNTIME_LIMIT = 80;
const SHELL = ['./','./index.html','./styles.css?v=72','./themes.css?v=70','./app-config.js?v=69','./app.js?v=77','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
