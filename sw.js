const SHELL_CACHE = 'mica-shell-v81';
const RUNTIME_CACHE = 'mica-runtime-v1';
const RUNTIME_LIMIT = 80;
const SHELL = ['./','./index.html','./styles.css?v=76','./themes.css?v=71','./app-config.js?v=69','./app.js?v=81','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
