...
export function gradingBatchPlan({
  ...
  for (const item of items) {
    ...
    if (
      ...
      quantity <= 0 ||
      (available !== null &&
        (!Number.isInteger(available) || available <= 0 || quantity > available)) ||
      raw === null ||
      raw < 0 ||
      expected === null ||
      expected < 0 ||
...
export function inventoryHealth(
  ...
  const buckets = [
    { key: "0-30", label: "0–30 days", quantity: 0, costBasis: 0, currentValue: 0 },
    { key: "31-90", label: "31–90 days", quantity: 0, costBasis: 0, currentValue: 0 },
    { key: "91-180", label: "91–180 days", quantity: 0, costBasis: 0, currentValue: 0 },
    { key: "181+", label: "181+ days", quantity: 0, costBasis: 0, currentValue: 0 },
    { key: "unknown", label: "Date missing", quantity: 0, costBasis: 0, currentValue: 0 },
  ];
  ...
  const valued = included
    ...
    .filter((position) => position.value !== null && Number.isFinite(position.value))
